  ...
  return (
    <div className="w-72 h-72 lg:w-80 lg:h-80 flex flex-col border text-left  items-center  border-[#E3AD4B]  rounded-2xl bg-white/50  shadow-lg overflow-hidden">
      ...
      <div className="p-2.5 flex flex-col justify-center">
        <Link
          href={"/"}
          className="text-lg font-['poppins-light'] font-bold text-[#00354E] after:content-['_↗'] lg:text-xl">
          {cardTitle}
        </Link>
        <p className="text-xs text-shadow-xs font-['poppins-light'] font-medium text-[#00354E] lg:text-sm">
          {cardSubtitle}
        </p>
      </div>
    </div>
